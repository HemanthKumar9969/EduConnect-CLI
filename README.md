...
⚠️ Note: This db.properties file is explicitly excluded from Git tracking using .gitignore for security reasons. Never commit your real database credentials to GitHub!
...
You’ll see the console-based app running with the main menu.
...
📹 Demo
(Add your .gif file inside a demo/ folder in the root directory and link it like this: ![Demo](demo/your_demo.gif))

(Or link to a YouTube video: [![Demo Video](https://img.youtube.com/vi/YOUR_VIDEO_ID/0.jpg)](https://www.youtube.com/watch?v=YOUR_VIDEO_ID) )
